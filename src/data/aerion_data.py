...
class AerionData(ApproachData):
    ...
    def feature_groups(self):
        ...
        feature_groups['rwy_pos'] = lambda sample: [sample['input_traj'][:, 6:8], sample['dec_in_traj'][:, 3:5]]
    ...
    def _get_transforms(self):
        ...
        transforms.append(FeatureSliceNormalizer(name="dec_in_traj", indices=(3, 5), mean=self.rwy_pos_mean, std=self.rwy_pos_std))
