...
class BaseModule(pl.LightningModule):
    def __init__(
        ...
        pred_end_epsilon: float = 100.0,
        pred_end_min_consecutive: int = 3,
    ):
        super().__init__()
        ...
        self.pred_end_epsilon = pred_end_epsilon
        self.pred_end_min_consecutive = pred_end_min_consecutive
